...
- [x] Filter tabs — All / 🏆 Top 10 S&P / Watchlist (`currentFilter` state)
...
- [x] Add GOOG to QUARTERLY_TICKERS in `update-expected-moves-ib.py`
- [x] Fix `DEFAULT_PORT` comment (live account, port 4002)
